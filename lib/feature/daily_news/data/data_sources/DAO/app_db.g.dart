    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `article` (`pid` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, `id` INTEGER, `author` TEXT, `name` TEXT, `title` TEXT, `description` TEXT, `url` TEXT, `urlToImage` TEXT, `publishedAt` TEXT, `content` TEXT)');
...
class _$ArticleDao extends ArticleDao {
  ...
  Future<List<ArticleModel>> getArticle() async {
    return _queryAdapter.queryList('SELECT ALL * FROM article',
  ...
  @override
  Future<void> delArticle(ArticleModel articleModel) async {
